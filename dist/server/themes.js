...
const block = (vars) => Object.entries(vars)
    .map(([k, v]) => `--${k}: ${v};`)
    .join("");
...
export function schemeCss(light, dark, mode) {
    if (mode === "light")
...
export function viewerThemeCss(t, mode) {
...
export function tokenThemeCss(t, mode) {
...
export const THEMES = [
    ...
    },
    {
        ...
        light: {
            ...
            border2: "#72A5A5",
            hover: "#E7F5F3",
            info: { bg: "#E7F5F3", text: "#00847C", border: "#008A8B" },
            success: { bg: "#ECF7E9", text: "#00847C", border: "#9FCD91" },
            warning: { bg: "#FFF6C8", text: "#8A6500", border: "#FFD424" },
            danger: { bg: "#FBEAE8", text: "#CE3E33", border: "#CE3E33" },
        },
        dark: {
            bg: "#071F26",
            panel: "#102F38",
            ...
            border2: "#008A8B",
            hover: "#123F48",
            info: { bg: "#0B3A43", text: "#00A58D", border: "#008A8B" },
            success: { bg: "#113D37", text: "#9FCD91", border: "#00A58D" },
            warning: { bg: "#3D3614", text: "#FFD424", border: "#FFD424" },
            danger: { bg: "#3A2425", text: "#FF8A80", border: "#CE3E33" },
        },
    },
    {
        id: "gruvbox",
